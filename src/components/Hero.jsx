...
export default function Hero() {
    return (
        <section
            id="home"
            className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-[10%] pt-28 md:pt-0 gap-10"
        >
            <motion.div
            ...
            >
                <h3 className="text-xl md:text-3xl font-bold">Hi!!...</h3>
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold my-2">I'm {portfolioData.name}</h1>
